...
<body>
    ...
    <section id="navbar">
        <div class="container">
            <div class="row sow">
                ...
                <div class="col-md-7" style="width: 0;">
                    <div class="main">
    ...
    <section id="pageHead">
        <div class="navBarMyAcc">
            <div class="row">
                <div class="col-md-3">
                    <span>
                        <div class="row">
                            <div class="col-md-5">
                                <a href="{{ route('getAccDashboard') }}">My Account</a>
                ...
                <div class="col-md-3">
                    <span>
                        <a href="{{ route('getYourOrder') }}">Orders</a>
                    </span>
                </div>
            </div>
        </div>
    ...
    function togglePasswordConfirm2() {
        var passwordInput = document.getElementById("password_confirmation2");
        var eyeIcon = document.getElementById("eyeIconConfirm2");
